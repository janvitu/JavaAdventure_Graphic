...
public class HerniPlan {
    ...
    private void zalozProstoryHry() {
        ...
        * */
        ...
        Postava profesorAlchymie            = new Postava("Profesor_alchymie", klicKnihovna, "Dobrý den, pokud hledáte vědomosti mohu vám půjčit klíče od knihovny.\nAha to jste vy!!! No dobrá nevím co vám mám říkat některé případy\nano případy tak tomu dnes říkáme byly objeveni naprosto znetvořené a některé dokonce polyté kyselinou.\nNeumím si to vysvětlit. Tady máte klíč od knihovny.");
